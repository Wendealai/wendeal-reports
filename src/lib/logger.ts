...
export const logger = {
  ...
  warn: (message: string, metadata?: Record<string, unknown>, error?: Error) => 
    log(LogLevel.WARN, message, undefined, metadata, error),
    
  error: (message: string, metadata?: Record<string, unknown>, error?: Error) => 
    log(LogLevel.ERROR, message, undefined, metadata, error),
    
  fatal: (message: string, metadata?: Record<string, unknown>, error?: Error) => 
    log(LogLevel.FATAL, message, undefined, metadata, error),
};
...
export const createLogger = (module: string) => ({
  ...
  warn: (message: string, metadata?: Record<string, unknown>, error?: Error) => 
    log(LogLevel.WARN, message, module, metadata, error),
    
  error: (message: string, metadata?: Record<string, unknown>, error?: Error) => 
    log(LogLevel.ERROR, message, module, metadata, error),
    
  fatal: (message: string, metadata?: Record<string, unknown>, error?: Error) => 
    log(LogLevel.FATAL, message, module, metadata, error),
});
...
export class ContextLogger {
  ...
  warn(message: string, metadata?: Record<string, unknown>, error?: Error): void {
    log(LogLevel.WARN, message, this.module, { ...this.context, ...metadata }, error);
  }

  error(message: string, metadata?: Record<string, unknown>, error?: Error): void {
    log(LogLevel.ERROR, message, this.module, { ...this.context, ...metadata }, error);
  }

  fatal(message: string, metadata?: Record<string, unknown>, error?: Error): void {
    log(LogLevel.FATAL, message, this.module, { ...this.context, ...metadata }, error);
  }
}
