...
export function AdvancedSearchBar({ onSearch, className }: AdvancedSearchBarProps) {
  ...
  const handleSearch = () => {
    ...
    if (trimmedQuery || Object.keys(searchFilters).length > 0) {
      const resultCount = getFilteredReports(trimmedQuery, searchFilters).length;
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button
                      variant={searchFilters.favoriteOnly ? "default" : "outline"}
                      size="sm"
                      onClick={() => 
                    ...
                    <Button
                      variant={searchFilters.readStatus === 'unread' ? "default" : "outline"}
                      size="sm"
                      onClick={() => 
                    ...
                    <Button
                      variant={searchFilters.readStatus === 'completed' ? "default" : "outline"}
                      size="sm"
                      onClick={() => 
